...
public class Main {
    public static void main(String[] args) {
        ...
        //m1Buscar(list, "developer");
    }
    private static void m1Buscar(List<Cliente> list, String searchText) {
    ...
    private static void m2Descendente(List<Cliente> list) {
    ...
    private static void m3Adulto(List<Cliente> list) {
    ...
    public static void m4MayorAdulto(List<Cliente> list) {
        list.stream()
    ...
    public static void m5MaxMinSalario(List<Cliente> list) {
    ...
    public static void m6Promedio(List<Cliente> list) {
    ...
    public static void m7Resumen(List<Cliente> list) {
    ...
    public static void m8Distinto(List<Cliente> list) {
        list.stream()
                .distinct()
                .forEach(System.out::println);
    }

    public static void m9Contar(List<Cliente> list) {
    ...
    public static void m10skipLimit(List<Cliente> list) {
        list.stream()
                .skip(4)
                .limit(2)
                .forEach(System.out::println);
    ...
    public static void m11getAnyYounger(List<Cliente> list) {
    ...
    public static void m12map(List<Cliente> list) {
        list.stream()
                .map(e -> {
    ...
    public static void m12flatMap(List<Cliente> list) {
        list.stream()
                .flatMap(e -> {
                    e.setSalario(e.getSalario() * 1.10);
    ...
    public static void m14peek(List<Cliente> list) {
    ...
    public static void m15GroupBy(List<Cliente> list) {
    ...
    public static void m16ToMapToSet(List<Cliente> list) {
    ...
    public static void m17Order(List<Cliente> list) {
        list.stream()
